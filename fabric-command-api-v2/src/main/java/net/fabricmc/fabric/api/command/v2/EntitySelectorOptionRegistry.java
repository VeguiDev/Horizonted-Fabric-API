...
public final class EntitySelectorOptionRegistry {
	...
	public static void register(ResourceLocation id, Component description, EntitySelectorOptions.Modifier handler, Predicate<EntitySelectorParser> canUse) {
		EntitySelectorOptionsAccessor.callRegister(toUnderscoreSeparatedString(id), handler, canUse, description);
	}
	...
	private static String toUnderscoreSeparatedString(ResourceLocation id) {
