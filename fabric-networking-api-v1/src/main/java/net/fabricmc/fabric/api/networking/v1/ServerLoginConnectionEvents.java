...
public final class ServerLoginConnectionEvents {
	 ...
	 *
	 * @see ServerLoginNetworking#registerReceiver(net.minecraft.server.network.ServerLoginPacketListenerImpl, net.minecraft.resources.ResourceLocation, ServerLoginNetworking.LoginQueryResponseHandler)
	 */
