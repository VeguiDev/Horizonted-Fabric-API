...
public interface FabricServerConfigurationNetworkHandler {
	 ...
	 *
	 * <p>Before adding a task use {@link ServerConfigurationNetworking#canSend(ServerConfigurationPacketListenerImpl, net.minecraft.resources.ResourceLocation)}
	 ...
	 * Upon receiving this packet the server should call {@link ServerConfigurationPacketListenerImpl#finishCurrentTask(ConfigurationTask.Type)},
